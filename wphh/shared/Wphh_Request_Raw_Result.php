...
/**
 * This class implements the Wphh_Request_Result interface and handles the return of Wphh_Request->get_param() as raw data, without any sanitization.
 * @package wphh
 * @subpackage shared
 * @since 1.0.0
 * @implements
 */
class Wphh_Request_Raw_Result implements Wphh_Request_Result {
